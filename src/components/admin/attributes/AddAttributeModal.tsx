...
import { CreateAttribute, type AttributeValue } from "../../../api/attributes";
...
export default function AddAttributeModal({ isOpen, onClose }: AddAttributeModalProps) {
  ...
  const updateValue = (index: number, field: keyof AttributeValue, newValue: string) => {
    ...
    <div className="edit-modal-overlay" onClick={onClose}>
      ...
      >
        <div className="edit-modal-header">
          <h3 className="edit-modal-title">Thêm thuộc tính mới</h3>
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="edit-modal-form-group" style={{ marginBottom: '20px' }}>
              ...
              <select 
                ...
                onChange={(e) => {
                  ...
                  setType(newType);
                  // Cập nhật lại danh sách giá trị nếu đổi sang color hoặc ngược lại
                    ...
                    {type === 'color' && (
                      <div style={{ position: 'relative', width: '40px', height: '40px' }}>
                        <input
                          type="color"
                          value={val.colorCode}
                          onChange={(e) => updateValue(idx, 'colorCode', e.target.value)}
                          style={{
          ...
          <div className="edit-modal-footer">
            ...
            >
              {addMutation.isPending ? 'Đang tạo...' : 'Tạo thuộc tính'}
            </button>
          </div>
        </form>
      </div>
